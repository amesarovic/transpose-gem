...
def Work2Transpose(spark: SparkSession, df: DataFrame) -> DataFrame:
    ...
    # NOTE: this code causes the Properties error in optimization mode
    dfs = []
    ...
    for df in dfs[1:]:
        transposed_df = df.union(other_df)
