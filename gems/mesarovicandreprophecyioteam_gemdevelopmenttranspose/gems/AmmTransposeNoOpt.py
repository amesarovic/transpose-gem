...
class AmmTransposeNoOpt(ComponentSpec):
    name: str = "AmmTransposeNoOpt"
    ...
    class AmmTransposeNoOptProperties(ComponentProperties):
    ...
    def validate(self, context: WorkflowContext, component: Component[AmmTransposeNoOptProperties]) -> List[Diagnostic]:
        diagnostics = []
    ...
    def onChange(self, context: WorkflowContext, oldState: Component[AmmTransposeNoOptProperties], newState: Component[AmmTransposeNoOptProperties]) -> Component[
    AmmTransposeNoOptProperties]:
        return newState

    class AmmTransposeNoOptCode(ComponentCode):
        def __init__(self, newProps):
            self.props: AmmTransposeNoOpt.AmmTransposeNoOptProperties = newProps
